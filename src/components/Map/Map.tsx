  ...
  const [userCoordinates, setUserCoordinates] = useState<any>({
    ...
    useEffect(() => {
      if(Constants.expoConfig?.extra) {
        setApiKey(
          Platform.OS === "android"
            ? Constants.expoConfig?.extra.ANDROID_MAP_KEY as string
            : Constants.expoConfig?.extra.IOS_MAP_KEY as string
        );
       
        setDirectionsApiKey(
          Constants.expoConfig?.extra.DIRECTIONS_KEY as string
        )
      }
